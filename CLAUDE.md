...
- `agents/` — Markdown-based agent prompts for multi-agent automation via Claude Code. Symlinked to `~/.claude/agents/` by `install.sh` so they're available from any repo.
